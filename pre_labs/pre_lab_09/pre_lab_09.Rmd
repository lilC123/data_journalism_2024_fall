...
My URL: https://datawrapper.dwcdn.net/xz63j/1/
...
The map now only shows Maryland and it is properly zoomed-in.
...
Now, when your cursor is on a given county, it shows the name and percentage in a nice format, instead of the FIPS code and long number.
...
My URL: https://datawrapper.dwcdn.net/n9hbA/1/
