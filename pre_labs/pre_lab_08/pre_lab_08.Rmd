...
md_voters has 24 rows and 18 columns.
...
**Answer** Line 60 creates a new dataframe called md_voters that will replace our current md_voters. Line 61 is the main difference, as the new md_voters will have a new column called "UNAF_DIFF", made by subtracting the "UNAF_2024" column by the "UNAF_2022" column. Then on line 63, we make a new dataframe called maryland_top_counties that is basically just md_voters arranged in descending order of our new "UNAF_DIFF" column, as shown in line 64. Then, we remove all columnss from the dataframe besises "County" and "UNAF_DIFF", since those are the only counties we are interested in for this particular dataframe. Line 66 puts a cut-off point after the 10th row of data, and line 68 calls the new dataframe so we can see it.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**
I see a bar chart with 10 bars and "County" on the x-axis and "count" on the y-axis.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It is the same chart, except now the bars are arranged in increasing order from left to right.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It is the same chart, except now the bars are oriented horizontally, arranged in decreasing order from top to bottom.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** It is the same chart, except now the background is completely white instead of gray.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer** Now, the chart has a light blue background and white lines running through each bar.
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer** The chart now has a title, a different y-axis label, and x-axis label.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**
I see a dataframe with a "date" column and "total_contributions" column arranged in ascending date order.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**
I see a line graph that shows a lot of up-and-down fluctuation.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**
The chart looks very similar to before except the x-axis has labels of specific dates.
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer**
It is the same chart, except now the date labels on the x-axis are rotated 45 degreees and more readable.
