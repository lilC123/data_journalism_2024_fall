...
**Task** Export the CSV file to your pre_lab_06 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer** There are lots of 'NA' values in the data as it has taken the top row of data and used the numbers as column names.
...
**Task** Get rid of rows we don't need by running the codeblock below. What problems remain? **Answer** The column names are still unidentifiable.
...
**Task** Run the codeblock below. What changed, and what issues or problems remain? **Answer** Some columns have actual names that make sense now, though some still do not.
