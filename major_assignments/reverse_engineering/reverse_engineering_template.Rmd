...
* **Analysis summary**: The reverse engineering produced different findings as the report. Our code found that 42.13% of Peter Franchot's contributions ($4.1 million) came from Maryland contributors.

```{r}
franchot_contribs <- clean_names(read_csv("data/moore_contribs.csv"))
franchot_contribs_md <- clean_names(read_csv("data/moore_contribs_md.csv"))
